...
namespace KinectoSoar.ScreenManager
{
    class GameScreen : Screen
    {
        ...
        public override void Draw()
        {
            ...
            Vector2 scoreSize = Resources.Instance.GetFont("Cooper").MeasureString("Score: " + Resources.Instance.Score.ToString());
            _spriteBatch.DrawString(Resources.Instance.GetFont("Cooper"), "Score: " + Resources.Instance.Score.ToString(), new Vector2((_game.GraphicsDevice.Viewport.Width - scoreSize.X) / 2, 10), Color.Yellow);
        }
        ...
        public override void Update(ref Screen activeScreen, GameTime gameTime)
        {
            ...
            {
                if (Resources.Instance.Score > Resources.Instance.HighScore)
                {
                    Resources.Instance.HighScore = Resources.Instance.Score;
                }
            }
